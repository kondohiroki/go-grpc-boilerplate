...
const _SYSTEM_CODE int = 10 // 10 is the system code
...
var (
	...
	SUBCODE_BLOCKED_LOAN_APPLICATION_ERROR errorSubcode = newErrorSubcode(765)
	SUBCODE_REQUIRED_FIELD_NOT_FOUND_ERROR errorSubcode = newErrorSubcode(766)
